    ...
    <div className="min-h-[60vh] flex items-center justify-center px-4 py-16 relative overflow-hidden">
      ...
      <div className="text-center max-w-md relative z-10">
        <div className="relative w-24 h-24 mx-auto mb-6">
          ...
          <div className="relative w-full h-full bg-dark-800 border border-blue-500/20 rounded-2xl flex items-center justify-center">
            <User className="w-10 h-10 text-blue-400" />
          </div>
        </div>

        <h1 className="text-xl font-bold text-white mb-2">
          {tr('Account Error', 'အကောင့်အမှားဖြစ်နေပါတယ်')}
        </h1>
        <p className="text-gray-400 mb-2 text-sm">
          {tr(
            'We couldn\'t load your account. Please try again.',
            'သင့်အကောင့်ကို ဖွင့်၍မရပါ။ ထပ်ကြိုးစားပါ။'
          )}
        </p>
