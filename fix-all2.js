...
function processFiles() {
    ...
    let indexTs = fs.readFileSync('src/lib/telegram-bot/index.ts', 'utf-8').replace(/\r\n/g, '\n');
    
    // Replace all handler calls in index.ts to pass ctx.messageId (if not already done)
